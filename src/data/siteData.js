...
import amanah4 from '../assets/amanah mall/amana mall 4.JPG';
...
import chamber2_5 from '../assets/chamber of commerce 2/IMG_9024.JPG';
import chamber2_6 from '../assets/chamber of commerce 2/IMG_9025.JPG';
import chamber2_7 from '../assets/chamber of commerce 2/IMG_9027.JPG';
import chamber2_8 from '../assets/chamber of commerce 2/IMG_9030.JPG';
import chamber2_9 from '../assets/chamber of commerce 2/IMG_9032.JPG';
import chamber2_10 from '../assets/chamber of commerce 2/IMG_9034.JPG';
import chamber2_11 from '../assets/chamber of commerce 2/IMG_9071.JPG';
...
import ration4_4 from '../assets/jhang rashan distribution/14.jpg';
import ration4_5 from '../assets/jhang rashan distribution/2.jpg';
import ration4_6 from '../assets/jhang rashan distribution/3.jpg';
import ration4_7 from '../assets/jhang rashan distribution/4.jpg';
import ration4_8 from '../assets/jhang rashan distribution/5.jpg';
import ration4_9 from '../assets/jhang rashan distribution/6.jpg';
...
export const heroSlides = [
  {
    id: 1,
    title: "Activate Pakistan's Compassion Economy",
    description: "Join BNWO to turn local care into large-scale change with community-led food, health, and education drives.",
    btn1: { text: "Join the Mission", link: "/membership" },
    btn2: { text: "Discover Our Story", link: "/about" },
    bg: hero1,
  },
  {
    id: 2,
    title: "12 High-Impact Programs, One Purpose",
    description: "From skill training and literacy to clean water and emergency health care, our welfare programs are built for real community impact.",
    btn1: { text: "See Programs", link: "/programs" },
    btn2: { text: "How We Deliver", link: "/what-we-do" },
    bg: hero2,
  },
  {
    id: 3,
    title: "7-Tier Governance for Total Accountability",
    description: "Our unique parliament model and 24 committees ensure every project is transparent, local, and results-focused.",
    btn1: { text: "Explore Parliament", link: "/parliament" },
    btn2: { text: "Meet Committees", link: "/committees" },
    bg: hero3,
  },
  {
    id: 4,
  ...
  {
    id: 5,
    title: "Join the Movement for a Stronger Nation",
    description: "Together we create sustainable opportunity, dignity, and support for every community across Pakistan.",
    btn1: { text: "Become a Partner", link: "/membership" },
...
export const eventsData = [
  ...
  {
    id: 7,
    title: "Chamber of Commerce Partnership Forum",
    date: "April 10, 2026",
    time: "11:00 AM - 3:00 PM",
    location: "Chamber of Commerce, Lahore",
    description:
  ...
  },
  {
    ...
    description:
      "BNWO held a community awareness and welfare drive at Amanah Mall, connecting with families, sharing information about our programs, and building support for education and outreach initiatives across Lahore.",
    fullDescription:
      "The Amanah Mall Community Drive brought together BNWO volunteers, partner organizations, and local families for a full day of awareness and engagement. Our teams guided visitors about ongoing welfare projects, youth skill-building programs, education support, and how communities can directly participate in social impact activities. The event also featured one-on-one interactions with families to understand their needs and improve future support planning.",
    image: amanah1,
    gallery: [
      amanah1,
      amanah2,
