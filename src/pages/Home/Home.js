          ...
          <div className="about-grid">
            ...
            <div className="about-side">
              <div className="side-card">
                <img src={flettisEventImage} alt="Flettis Event" className="side-card__img" />
        ...
        <div className="container">
          <div className="parliament-grid">
            <div className="parliament-image">
              <img src={bnwoParlimentImage} alt="Best Nation Parliament" />
            </div>
            <div className="parliament-content">
              <h2>Best Nation Parliament</h2>
              <p className="parliament-tagline">Together for a Stronger Nation</p>
              <p className="parliament-description">
                The Best Nation Parliament is a collaborative platform dedicated to bringing together thought leaders, policymakers, and community advocates to drive positive change across education, health, employment, human rights, social welfare, and environmental initiatives.
              </p>
              <div className="parliament-features">
                <div className="parliament-feature">
              ...
              <a href="https://docs.google.com/forms/d/e/1FAIpQLScTCOHr6lbZqFPfnY826H8ecU0mJ14d12FFlVG-Q6PuLCisjQ/viewform?usp=header" target="_blank" rel="noopener noreferrer" className="btn-primary">
                Join Parliament Membership <i className="fas fa-arrow-right"></i>
              </a>
            </div>
          </div>
        </div>
